...
This leaves an important fact unstated: remembering a notebook, journal, drawing, or project does not mean
the physical object is in a city pocket, and failing to see an object in the current room does not mean it was
lost or stolen. In the one-hour Alderbank run, two residents independently made unsupported public claims
about a missing bag or notebook. Private contents were not reviewed, so the workshop is a hypothesis rather
than a proven cause.
