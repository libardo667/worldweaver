...
### 1. Remove the remaining compulsory prompt feed

Delete the random citywide conversation floor left by Major 60. Keep exact local speech, direct
correspondence, local traces, action receipts, and elective `chatter` reads.

### 2. Put identity growth under resident authority
...
### 3. Finish the human-surface split
...
### 7. Finish resident portability and recovery
