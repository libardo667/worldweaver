...
def upgrade() -> None:
    ...
    if inspector.has_table("social_feedback_events"):
        op.drop_index("ix_social_feedback_events_created_at", table_name="social_feedback_events")
        op.drop_index("ix_social_feedback_events_source_actor_id", table_name="social_feedback_events")
        op.drop_index("ix_social_feedback_events_target_actor_id", table_name="social_feedback_events")
