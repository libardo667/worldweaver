...
def build_action_narration_system_prompt() -> str:
    ...
    return "\n".join(
        [
            ...
            "- public_summary must be a single outward-facing observable summary of what someone else would have seen.",
            "- public_summary must not use second person or report hidden inner experience.",
            "- public_summary should read cleanly as a public last-action line.",
