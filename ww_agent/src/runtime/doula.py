...
class DoulaLoop:
    ...
    async def _seed_and_spawn(
        ...
        *,
        ...
        # Avoid writing the removed wander/rest scheduler controls. The location
        # values below remain compatibility/provenance metadata; CognitiveCore does
        # not currently read them from tuning.json after the one-time entry token.
        default_tuning: dict = {
