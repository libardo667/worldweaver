...
DEFAULT_DIVERSITY_ACTIONS: List[str] = [
    "I ask a nearby person what changed here recently and why it matters now.",
    "I leave a short note for a possible ally, then observe from a safe distance.",
    "I inspect the immediate area for one concrete risk no one has called out yet.",
    "I choose a less obvious path to test whether someone is tracking my movement.",
    "I offer practical help to someone under pressure in exchange for one useful detail.",
    "I trigger a small confrontation to see who reveals themselves under stress.",
    "I pause to stabilize supplies and reduce immediate risk before continuing.",
    "I seek local rumors and trade information instead of escalating by force.",
    "I shift focus to a side objective that could change later options.",
    "I try to repair a damaged system, tool, or process to open future paths.",
    "I test a risky shortcut that saves time but could increase danger.",
    "I gather verifiable evidence before I commit to any contested claim.",
    "I revisit a previously important location to measure what has changed.",
    "I negotiate a limited agreement that trades one concession for safe passage.",
    "I set a decoy signal to provoke a response from hidden observers.",
    "I escalate publicly to force key actors to declare their position.",
    "I de-escalate, conceal my intent, and wait for a stronger opening.",
    "I attempt a quiet extraction of a high-value person or object.",
    "I disable a chokepoint to restrict hostile movement on later turns.",
    "I prioritize protecting bystanders even if it slows direct progress.",
]
