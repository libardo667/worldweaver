...
- `improvements/majors/33-centralize-agent-inference-in-the-slow-loop-and-packetize-runtime-control.md`
- `improvements/majors/34-reframe-worldweaver-as-a-maturation-environment-for-embodied-ai.md`
- `improvements/WORLD_FACT_GRAPH.md`
- `improvements/MULTI_TEMPO_AGENTS.md`
- `ww_agent/src/resident.py`
- `ww_agent/src/runtime/signals.py`
- `ww_agent/src/loops/slow.py`
