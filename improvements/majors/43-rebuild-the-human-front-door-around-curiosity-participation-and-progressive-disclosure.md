...
- `improvements/FRONTEND_PROBLEMS.md`
- `improvements/FRONTEND_OVERHAUL.md`
- `improvements/minors/34-simplify-first-run-entry-into-look-around-vs-join.md`
- `improvements/minors/35-remove-mentor-board-from-public-onboarding.md`
- `improvements/minors/36-split-entry-screen-into-flow-components.md`
- `improvements/minors/37-split-settings-into-account-narration-and-continuity-surfaces.md`
- `improvements/minors/38-decompose-app-shell-into-mode-specific-hooks-and-surfaces.md`
