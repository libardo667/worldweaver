...
- Shard compose files mount shared backend code from `worldweaver_engine/` and
  ...
  contract.
- Major architectural specs now live at the workspace root under `improvements/`,
...
- Classify what remains outside `ww_engine/`:
  - shard instances
  - workspace-level improvements/history
...
- Ensure active major and minor specs refer to root-level `improvements/` paths
...
- `improvements/majors/21-prune-legacy-dev-architecture-and-unify-engine-kit.md`
- `improvements/majors/22-stabilize-shard-first-runtime-and-frontend-flows.md`
- `improvements/majors/11-shard-creation-framework.md`
