...
- `improvements/majors/42-govern-soul-evolution-with-immutable-canon-and-matured-growth.md`
- `ww_agent/tests/test_loop_packets.py`
- `ww_agent/tests/test_rest.py`
- `worldweaver_engine/tests/service/test_state_manager.py`
- `improvements/majors/35-deepen-the-fractal-architecture-with-resident-ledgers-and-subjective-fact-graphs.md`
- `improvements/majors/38-rebalance-resident-channel-salience-across-local-chat-mail-and-city-context.md`
