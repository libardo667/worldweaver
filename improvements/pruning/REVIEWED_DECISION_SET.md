...
4. `frontend_source`: `in_progress` (slices 1-2 complete: moved App runtime/config helper block into `appHelpers` and extracted topbar/mode shell into `AppTopbar`; strict reruns hit preexisting API flakes outside frontend paths)
- Evidence:
