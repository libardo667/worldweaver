...
4. `frontend_source` simplify: slices 1-2 completed (`BATCH_B_FRONTEND_SOURCE_SLICE_1.md`, `BATCH_B_FRONTEND_SOURCE_SLICE_2.md`)
  - Latest strict reruns hit preexisting API flaky nodes in world-event persistence paths; isolated reruns of both nodes passed.
