...
3. `tests_integration` simplify: slices 1-5 completed (`BATCH_B_TESTS_INTEGRATION_SLICE_1.md`, `BATCH_B_TESTS_INTEGRATION_SLICE_2.md`, `BATCH_B_TESTS_INTEGRATION_SLICE_3.md`, `BATCH_B_TESTS_INTEGRATION_SLICE_4.md`, `BATCH_B_TESTS_INTEGRATION_SLICE_5.md`)
